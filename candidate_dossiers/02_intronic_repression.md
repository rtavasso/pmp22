# Intronic enhancer: test a second regulatory route

- **Priority:** 2
- **Direction:** repression
- **Decisive experiment:** Test the intronic interval alone and jointly with distal C; distinguish transcription from splicing.
