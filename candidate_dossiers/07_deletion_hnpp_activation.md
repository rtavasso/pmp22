# Deletion-HNPP: test activation of the retained normal locus

- **Priority:** 6
- **Direction:** activation; deletion-HNPP only
- **Decisive experiment:** In deletion-HNPP lines with an intact retained coding allele, test graded local activation and measure RNA, protein and function.
- **Region:** PMP22_INTRONIC; GRCh38 chr17:15247916-15248159 (0-based, half-open; gene strand minus)
